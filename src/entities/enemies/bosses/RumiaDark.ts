...
const PHASES: BossPhase[] = [
	{
		...
		patterns: [
			...
			Patterns.RUMIA_ORB_RINGS_1_EN,
			Patterns.RUMIA_ORB_RINGS_2_EN,
			Patterns.RUMIA_ORB_RINGS_1_H,
			Patterns.RUMIA_ORB_RINGS_2_H,
			Patterns.RUMIA_ORB_RINGS_1_L,
			Patterns.RUMIA_ORB_RINGS_2_L,
		],
	},
	{
