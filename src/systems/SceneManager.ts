export enum Scene {
	...
	SPELLCARD_STAGE = 'spellcard-stage',
	SPELLCARD_LIST = 'spellcard-list',
	OPTIONS = 'options',
	GAME = 'game',
	KEYCONFIG = 'keyconfig',
...
export class SceneManager {
	...
	constructor() {
		this.sections = new Map([
			...
			[Scene.SPELLCARD_STAGE, this.getElem('spellcard-stage')],
			[Scene.SPELLCARD_LIST, this.getElem('spellcard-list')],
